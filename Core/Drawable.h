...
interface IDrawable {
    ...
    virtual void SetPipeline(IPipeline* pipeline, UniformVariable textureVar=UniformVariable{},
                             UniformVariable normalMapVar=UniformVariable{},
                             UniformVariable materialVar=UniformVariable{}) = 0;
